...
$tokenSpecs = @(
  ...
  @{ id = 'friend_lane'; value = ('friend-' + 'macos') },
  @{ id = 'friend_release_marker'; value = ('friend-' + 'private') },
  @{ id = 'friend_only_marker'; value = ('friend-' + 'only') },
  @{ id = 'combined_personal_lane'; value = ('private+' + 'friend') },
